...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#e0f2f1] flex items-center justify-center p-4 font-sans relative">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <button type="button" onClick={() => setShowForgotModal(true)} className="text-[10px] font-bold text-[#2ea391] hover:underline uppercase">Forgot Password?</button>
              </div>
              <input
                type="password"
                className="w-full bg-gray-50 border border-gray-100 p-4 rounded-2xl outline-none focus:ring-2 focus:ring-[#2ea391]/20 focus:bg-white transition-all"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-white rounded-3xl p-8 w-full max-w-md shadow-2xl relative">
            ...
            <div className="text-center mb-6">
              <div className="bg-[#2ea391]/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-[#2ea391] text-3xl">🔑</span>
              </div>
